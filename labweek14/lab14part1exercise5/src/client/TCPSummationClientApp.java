...
public class TCPSummationClientApp
{
	public static void main(String[] args) 
	{
		...
		try 
		{
			...
			System.out.println("\tReceiving total summation from server: " + resultSum);
			System.out.println("\tReceiving total multiplication from server: " + resultMult);
